...
namespace GLThreadGen
{
    public class CommandLineOptions
    {
        ...
        [Option('x', "inputxml", HelpText = "Input XML file to read.  Used to generate type-safe bindings for command buffers.  If this is not provided and the --noxml flag is not set, the XML will be downloaded from GitHub.")]
